...
from .system_metrics import get_system_status, sanitize_system_data
...
def get_ai_analysis():
    ...
    clean_status = sanitize_system_data(status)
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {'role': 'user', 'content': f'Atual situação do hardware: {clean_status}'}
        ]
    )
